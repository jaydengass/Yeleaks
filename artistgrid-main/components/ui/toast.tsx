...
function ToastViewport({ className, ref, ...props }: React.ComponentPropsWithRef<typeof ToastPrimitives.Viewport>) {
  return (
...
function ToastAction({ className, ref, ...props }: React.ComponentPropsWithRef<typeof ToastPrimitives.Action>) {
  return (
...
function ToastClose({ className, ref, ...props }: React.ComponentPropsWithRef<typeof ToastPrimitives.Close>) {
  return (
...
function ToastTitle({ className, ref, ...props }: React.ComponentPropsWithRef<typeof ToastPrimitives.Title>) {
